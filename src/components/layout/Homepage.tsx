...
import {
    Navbar, Container, Nav, Button, Form, InputGroup,
    Row, Col, Card, Badge, Carousel, Image, Alert
...
// Hàm format tiền tệ (TypeScript)
const formatCurrency = (value: number | undefined | null): string => {
    if (value === undefined || value === null) return '0₫';
    // Sử dụng Intl.NumberFormat để định dạng VNĐ
...
const HomePage: React.FC = () => {
    ...
    const discountDeals: Deal[] = [
        { id: 1, title: 'Burger Combo Deal', restaurant: 'Burger King Express', discount: '50% OFF', originalPrice: 250000, discountPrice: 125000, image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&h=350&fit=crop', badge: 'HOT DEAL', rating: 4.5, time: '15-20 min' },
        { id: 2, title: 'Pizza Feast', restaurant: 'Pizza Hut Deluxe', discount: '40% OFF', originalPrice: 350000, discountPrice: 210000, image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&h=350&fit=crop', badge: 'POPULAR', rating: 4.7, time: '25-30 min' },
        { id: 3, title: 'Sushi Premium Set', restaurant: 'Tokyo Sushi Bar', discount: '35% OFF', originalPrice: 450000, discountPrice: 292500, image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=500&h=350&fit=crop', badge: 'NEW', rating: 4.8, time: '20-25 min' },
        { id: 4, title: 'Pasta Italiano', restaurant: 'Italian Kitchen', discount: '45% OFF', originalPrice: 280000, discountPrice: 154000, image: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=500&h=350&fit=crop', badge: 'TRENDING', rating: 4.6, time: '18-22 min' },
        { id: 5, title: 'Healthy Bowl', restaurant: 'Fresh & Green', discount: '30% OFF', originalPrice: 180000, discountPrice: 126000, image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&h=350&fit=crop', badge: 'HEALTHY', rating: 4.4, time: '10-15 min' },
        { id: 6, title: 'BBQ Ribs Special', restaurant: 'Smokehouse BBQ', discount: '55% OFF', originalPrice: 500000, discountPrice: 225000, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=500&h=350&fit=crop', badge: 'BEST SELLER', rating: 4.9, time: '30-35 min' },
    ];

    // Dữ liệu Popular Restaurants (kiểu Restaurant[])
    const popularRestaurants: Restaurant[] = [
        { id: 1, name: "Phở Hà Nội", cuisine: 'Món Việt • Phở • Bún', time: '15-25 phút', price: '50.000₫ - 100.000₫', rating: 4.8, reviews: '2.5k+', image: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=400&h=300&fit=crop', favorite: false, deliveryFee: 'Miễn phí' },
        { id: 2, name: 'Gà Rán KFC', cuisine: 'Fastfood • Gà rán • Burger', time: '20-30 phút', price: '80.000₫ - 200.000₫', rating: 4.6, reviews: '5k+', image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400&h=300&fit=crop', favorite: true, deliveryFee: '15.000₫' },
        { id: 3, name: 'Lẩu Thái Tomyum', cuisine: 'Món Thái • Lẩu • Hải sản', time: '25-35 phút', price: '150.000₫ - 300.000₫', rating: 4.7, reviews: '1.8k+', image: 'https://images.unsplash.com/photo-1504544750208-dc0358e63f7f?w=400&h=300&fit=crop', favorite: false, deliveryFee: '20.000₫' },
        { id: 4, name: 'Sushi Tokyo', cuisine: 'Nhật Bản • Sushi • Sashimi', time: '30-40 phút', price: '200.000₫ - 500.000₫', rating: 4.9, reviews: '3.2k+', image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400&h=300&fit=crop', favorite: true, deliveryFee: 'Miễn phí' },
        { id: 5, name: 'Bún Chả Hương Liên', cuisine: 'Món Việt • Bún chả • Nem', time: '15-20 phút', price: '40.000₫ - 80.000₫', rating: 4.5, reviews: '4.1k+', image: 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=400&h=300&fit=crop', favorite: false, deliveryFee: 'Miễn phí' },
        { id: 6, name: 'Pizza 4P\'s', cuisine: 'Ý • Pizza • Pasta', time: '25-35 phút', price: '150.000₫ - 350.000₫', rating: 4.8, reviews: '6.7k+', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&h=300&fit=crop', favorite: true, deliveryFee: '25.000₫' },
        { id: 7, name: 'Cơm Tấm Sườn Bì', cuisine: 'Món Việt • Cơm tấm • Sườn', time: '10-15 phút', price: '35.000₫ - 70.000₫', rating: 4.4, reviews: '2.9k+', image: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=400&h=300&fit=crop', favorite: false, deliveryFee: 'Miễn phí' },
        { id: 8, name: 'Trà Sữa Gong Cha', cuisine: 'Đồ uống • Trà sữa • Smoothie', time: '5-10 phút', price: '30.000₫ - 60.000₫', rating: 4.6, reviews: '8.3k+', image: 'https://images.unsplash.com/photo-1525385444361-6c20d6c0eb74?w=400&h=300&fit=crop', favorite: true, deliveryFee: 'Miễn phí' },
    ];
            ...
            <div className="homepage-wrapper bg-light">
                <div className="bg-light min-vh-100">
                    ...
                    <Navbar
                        ...
                        // Sử dụng custom style để định nghĩa màu gradient/primary
                            ...
                            <Navbar.Brand href="#">
                                <div className="d-flex align-items-center">
                                    <div className="bg-white p-1 rounded shadow-sm me-2">
                                        <svg className="text-danger" style={{ width: '24px', height: '24px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h1 className="h5 fw-bold mb-0 text-white">Lunch<span className="text-warning">Bot</span></h1>
                    ...
                    {/* Hero Section */}
                    <div className="bg-gradient-primary-danger py-5 shadow-lg" style={{ backgroundColor: '#FF5E62', position: 'relative', overflow: 'hidden' }}>
                                ...
                                <Col md={7} lg={6} className="text-white z-1">
                                    ...
                                    <Card className="p-2 shadow-lg rounded-4 border-0">
                                        <Form className="d-flex flex-column flex-sm-row gap-2">
                                            ...
                                            <Button variant="warning" type="submit" className="fw-bold px-4 shadow-sm">
                                                Tìm kiếm
                                            </Button>
                                        </Form>
                                    </Card>
                                        ...
                                        >
                                            {foodCategories.map((category, index) => (
                                                <Carousel.Item key={index}>
                                                    <Card className={`text-center p-5 rounded-4 border-0 shadow-lg ${category.colorClass}`} style={{minHeight: '350px'}}>
                                                        <div className="d-flex flex-column align-items-center justify-content-center">
                                                            <div style={{ fontSize: '100px', marginBottom: '10px' }}>{category.image}</div>
                                ...
                                {discountDeals.map((deal) => (
                                    ...
                                    >
                                        <div className="position-relative">
                                            ...
                                            />
                                            <Badge bg="danger" className="position-absolute top-0 start-0 m-2 fw-bold p-2 shadow-sm">
                                                {deal.badge}
                                            </Badge>
                                            <Badge bg="warning" className="position-absolute top-0 end-0 m-2 fw-bold p-2 shadow-lg fs-6">
                                                {deal.discount}
                                            </Badge>
                                            <Badge bg="white" className="position-absolute bottom-0 start-0 m-2 p-2 shadow-sm text-dark">
                    ...
                    <div className="bg-white py-5">
                        <Container>
                            <div className="text-center mb-5">
                                ...
                                <div className="bg-primary mx-auto mt-3 rounded-pill" style={{ width: '60px', height: '3px' }}></div>
                            </div>
                                    ...
                                    <Col xs={12} sm={6} md={4} lg={3} key={restaurant.id}>
                                        <Card className="shadow-sm rounded-4 border-0 h-100">
                                            <div className="position-relative">
                                                ...
                                                <Badge bg="primary" className="position-absolute bottom-0 start-0 m-3 p-2 fw-bold shadow-sm">
                                            ...
                                            <Card.Body className="p-3 d-flex flex-column">
                                                ...
                                                <Card.Text className="text-muted small mb-3">{restaurant.cuisine}</Card.Text>

                                                <div className="d-flex align-items-center justify-content-between small text-dark mb-3">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between pt-2 border-top mt-auto">
                                                    <span className="small text-muted">Phí giao: <span className="fw-semibold text-success">{restaurant.deliveryFee}</span></span>
                        ...
                        <Container>
                            <Row className="g-4 mb-4">
                                ...
                                <Col xs={12} md={6} lg={4}>
                                    ...
                                    <p className="text-muted small mb-3">
                                        Nền tảng đặt đồ ăn và giao hàng hàng đầu tại Việt Nam. Đảm bảo chất lượng, tốc độ và dịch vụ khách hàng 24/7.
                                    </p>
                                ...
                                <Col xs={6} md={3} lg={2}>
                                    ...
                                    <ul className="list-unstyled small">
                                        <li><a href="#" className="text-muted text-decoration-none">Tìm kiếm Nhà hàng</a></li>
                                        <li><a href="#" className="text-muted text-decoration-none">Ưu đãi hôm nay</a></li>
                                        <li><a href="#" className="text-muted text-decoration-none">Giao hàng siêu tốc</a></li>
                                        <li><a href="#" className="text-muted text-decoration-none">Theo dõi đơn hàng</a></li>
                                    </ul>
                                </Col>
                                ...
                                <Col xs={6} md={3} lg={2}>
                                    ...
                                    <ul className="list-unstyled small">
                                        ...
                                        <li><a href="#" className="text-muted text-decoration-none">Trở thành đối tác</a></li>
                                    </ul>
                                </Col>
                                ...
                                <Col xs={12} md={6} lg={4}>
                                    ...
                                    <ul className="list-unstyled small">
                                        <li className="d-flex align-items-center text-muted mb-1">
                                            <Phone size={16} className="me-2 text-danger" /> +84 987 654 321
                                        </li>
                                        <li className="d-flex align-items-center text-muted">
                                            <Mail size={16} className="me-2 text-danger" /> support@lunchbot.vn
                                        </li>
                                    </ul>
                                </Col>
                            </Row>
                            ...
                            <div className="border-top border-secondary pt-4 mt-4 text-center">
                                <p className="text-muted small mb-0">
                                    © {new Date().getFullYear()} LunchBot. Đã đăng ký bản quyền. Được phát triển bởi CodeGym Vietnam.
                                </p>
                            </div>
                        </Container>
                    </footer>
